...
public class OVRGrabbable : MonoBehaviour
{
    ...
    virtual public void GrabBegin(OVRGrabber hand, Collider grabPoint)
    {
       ...
       if(grabPoint.name == "mayonaise") {
           GlobalData.ischeck = 1;
       }
       else if(grabPoint.name == "water") {
           GlobalData.ischeck = 2;
       }
       else if(grabPoint.name == "extinguisher_operate" || grabPoint.name == "extinguisher_meter") {
            GlobalData.ischeck = 3;
        }
